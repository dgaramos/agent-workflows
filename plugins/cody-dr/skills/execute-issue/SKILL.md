---
name: execute-issue
description: Cody DR orchestrates the full issue-to-change lifecycle: start-issue, implement-issue, and ship-change in sequence without pre-authorizing external actions.
---
