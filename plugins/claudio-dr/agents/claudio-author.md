---
name: claudio-author
description: Claudio DR entrypoint for authoring and publishing a single issue via the configured project publisher. Never uses gh issue create or any direct user-authenticated API call.
skills:
  - author-issue
---
